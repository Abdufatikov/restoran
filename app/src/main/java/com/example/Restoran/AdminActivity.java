...
public class AdminActivity extends AppCompatActivity {
    ...
    private void loadProducts() {
        String url = "http://10.0.2.2/restoran_api/getProducts.php";
    ...
    private void addProduct() {
        ...
        String url = "http://10.0.2.2/restoran_api/add_product.php";
    ...
    private void updatePrice() {
        ...
        String url = "http://10.0.2.2/restoran_api/update_price.php";
    ...
    private void deleteProduct(int productId) {
        String url = "http://10.0.2.2/restoran_api/delete_product.php";
